...
void XmlLogger::writeToLogMap(const Map &map, const std::list<std::shared_ptr<Node>>& path)
{
...
void XmlLogger::writeToLogPath(const std::list<std::shared_ptr<Node>>& path)
{
...
void XmlLogger::writeToLogHPpath(const std::list<std::shared_ptr<Node>>& hppath)
{
