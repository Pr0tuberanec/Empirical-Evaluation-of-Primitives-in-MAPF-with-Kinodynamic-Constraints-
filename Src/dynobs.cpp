...
// // //         std::unordered_set<int> active_obstacles;
// // //         size_t max_obs_time = findMaxObsTime(stop_time, map, active_obstacles, obstacles_paths);
        
// // //         int current_cell;
// // //         int previous_time_step;
// // //         std::unordered_map<int, int> timesteps;
// // //         for(size_t time = 0; time < max_obs_time; ++time) {
// // //             std::vector<size_t> to_remove;
// // //             for(auto obs_idx: active_obstacles) {
